...
This project aims to test and training of deep convolutional neural networks.

Software used:
[Caffe](http://caffe.berkeleyvision.org/) to classify images and pre-defined joode Caffe model.
[Oxford 102 category flower dataset](http://www.robots.ox.ac.uk/~vgg/data/flowers/102/index.html).
[ILSVRC 2012 (ImageNet) data](http://www.image-net.org/challenges/LSVRC/2012/).
